  ...
  try {
    ...
    for (const sp of species) {
      ...
      validationResults.push({
        ...
        warnings,
        iucnData: iucnData ? {
          id: iucnData.assessment_id,
          status: iucnData.red_list_category,
          kingdom: iucnData.kingdom,
          phylum: iucnData.phylum,
          class: iucnData.class_name,
          order: iucnData.order_name,
          family: iucnData.family,
          genus: iucnData.genus,
          species: iucnData.species,
        } : null,
        gbifData: gbifData ? {
          key: gbifData.key,
          matchType: gbifJson.results[0]?.matchType,
          acceptedName: gbifData.acceptedUsageName,
          datasetKey: gbifData.datasetKey,
        } : null,
      });
    }
