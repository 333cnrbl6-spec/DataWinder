  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      ...
      <button
        ...
        className="w-14 h-14 rounded-full shadow-2xl border-4 border-bangor-red overflow-hidden hover:scale-110 transition-transform duration-200 bg-white ring-4 ring-bangor-red/20"
